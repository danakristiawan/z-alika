<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Tambah SPT Pegawai</h1>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="npwp" class="form-control <?= form_error('npwp') ? 'is-invalid' : ''; ?>">
                    <div class="invalid-feedback">
                        <?= form_error('npwp'); ?>
                    </div>
                </div>
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="alamat" class="form-control <?= form_error('alamat') ? 'is-invalid' : ''; ?>">
                    <div class="invalid-feedback">
                        <?= form_error('alamat'); ?>
                    </div>
                </div>
            ...
            <div class="col-lg-3">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="kdjab" class="form-control <?= form_error('kdjab') ? 'is-invalid' : ''; ?>">
                    <div class="invalid-feedback">
                        <?= form_error('kdjab'); ?>
                    </div>
                </div>
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="nourut" class="form-control <?= form_error('nourut') ? 'is-invalid' : ''; ?>">
                    <div class="invalid-feedback">
                        <?= form_error('nourut'); ?>
                    </div>
                </div>
